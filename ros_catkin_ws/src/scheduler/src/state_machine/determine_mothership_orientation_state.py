    ...
    def run(self):
        ...
        try:
            ...
            if detected_slot != 0xFF:
                ...
                rospy.loginfo("Detected:", "ABC" if detected_slot.letter == 0 else "DEF", "  MOTHERSHIP ORIENTATION: ", globals.mothership_theta, "POSITION:", globals.mothership_x, " ", globals.mothership_y)
