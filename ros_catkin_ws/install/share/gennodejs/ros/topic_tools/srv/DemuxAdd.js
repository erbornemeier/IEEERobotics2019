...
class DemuxAddRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DemuxAddRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DemuxAddRequest(null);
...
class DemuxAddResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DemuxAddResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DemuxAddResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'topic_tools/DemuxAdd'; }
};
